...
// $Id: hardware.php,v 1.34 2006/06/16 10:27:34 bigmichi1 Exp $
...
function html_hardware () {
	...
	if( $XPath->match( "/phpsysinfo/Hardware/CPU/Number" ) ) {
		$_text .= "  <tr>\n    <td width=\"30%\" class=\"row1\" valign=\"top\"><font size=\"-1\">" . $text['numcpu'] . "</font></td>\n    <td class=\"row1\"><font size=\"-1\">" . $XPath->getData( "/phpsysinfo/Hardware/CPU/Number" ) . "</font></td>\n  </tr>\n";
	} 
	if( $XPath->match( "/phpsysinfo/Hardware/CPU/Model" ) ) {
		$_text .= "  <tr>\n    <td class=\"row1\" valign=\"top\"><font size=\"-1\">" . $text['cpumodel'] . "</font></td>\n    <td class=\"row1\"><font size=\"-1\">" . $XPath->getData( "/phpsysinfo/Hardware/CPU/Model" );
	...
	if( $XPath->match( "/phpsysinfo/Hardware/CPU/Cpuspeed" ) ) {
		$_text .= "  <tr>\n    <td class=\"row1\" valign=\"top\"><font size=\"-1\">" . $text['cpuspeed'] . "</font></td>\n    <td class=\"row1\"><font size=\"-1\">" . format_speed( $XPath->getData( "/phpsysinfo/Hardware/CPU/Cpuspeed" ) ) . "</font></td>\n  </tr>\n";
	}
	if( $XPath->match( "/phpsysinfo/Hardware/CPU/Busspeed" ) ) {
		$_text .= "  <tr>\n    <td class=\"row1\" valign=\"top\"><font size=\"-1\">" . $text['busspeed'] . "</font></td>\n    <td class=\"row1\"><font size=\"-1\">" . format_speed( $XPath->getData( "/phpsysinfo/Hardware/CPU/Busspeed" ) ) . "</font></td>\n  </tr>\n";
	}
	if( $XPath->match("/phpsysinfo/Hardware/CPU/Cache" ) ) {
		$_text .= "  <tr>\n    <td class=\"row1\" valign=\"top\"><font size=\"-1\">" . $text['cache'] . "</font></td>\n    <td class=\"row1\"><font size=\"-1\">" . format_bytesize( $XPath->getData( "/phpsysinfo/Hardware/CPU/Cache" ) ) . "</font></td>\n  </tr>\n";
	}
	if( $XPath->match( "/phpsysinfo/Hardware/CPU/Bogomips" ) ) {
		$_text .= "  <tr>\n    <td class=\"row1\" valign=\"top\"><font size=\"-1\">" . $text['bogomips'] . "</font></td>\n    <td class=\"row1\"><font size=\"-1\">" . $XPath->getData( "/phpsysinfo/Hardware/CPU/Bogomips" ) . "</font></td>\n  </tr>\n";
	}
	$_text .= "  <tr>\n    <td class=\"row1\" valign=\"top\"><font size=\"-1\">" . $text['pci'] . "</font></td>\n    <td class=\"row1\">";
	...
	$_text .= "  <tr>\n    <td class=\"row1\" valign=\"top\"><font size=\"-1\">" . $text['ide'] . "</font></td>\n    <td class=\"row1\">";
	if( $strIdedevices ) {
	...
	$_text .= "  <tr>\n    <td class=\"row1\" valign=\"top\"><font size=\"-1\">" . $text['scsi'] . "</font></td>\n    <td class=\"row1\">";
	if( $strScsidevices ) {
		$_text .= "<table>" . $strScsidevices . "</table></td>\n  </tr>";
	} else {
		$_text .= "<font size=\"-1\"><i>" . $text['none'] . "</i></font></td></tr>";
	}
	
	$_text .= "  <tr>\n    <td class=\"row1\" valign=\"top\"><font size=\"-1\">" . $text['usb'] . "</font></td>\n    <td class=\"row1\">";
	if( $strUsbdevices) {
