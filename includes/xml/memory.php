...
////foreach( $arrMem['devswap'] as $arrDevice) {
	if (isset($arrMem['devswap']) && is_array($arrMem['devswap'])) {
		foreach( $arrMem['devswap'] as $arrDevice) {
			$_text .="    <Mount>\n"
...
function html_memory () {
	...
	$_text = "<table border=\"0\" align=\"center\" cellpadding=\"4\" cellspacing=\"1\" width=\"95%\" class=\"forumline\">\n"
		. "  <tr>\n"
		. "    <th class=\"row1\" align=\"" . $textdir['center'] . "\" valign=\"top\"><font size=\"-1\"><b>" . $text['type'] . "</b></font></th>\n"
		. "    <th class=\"row1\" align=\"" . $textdir['center'] . "\" valign=\"top\"><font size=\"-1\"><b>" . $text['percent'] . "</b></font></th>\n"
		. "    <th class=\"row1\" align=\"" . $textdir['center'] . "\" valign=\"top\"><font size=\"-1\"><b>" . $text['free'] . "</b></font></th>\n"
		. "    <th class=\"row1\" align=\"" . $textdir['center'] . "\" valign=\"top\"><font size=\"-1\"><b>" . $text['used'] . "</b></font></th>\n"
		. "    <th class=\"row1\" align=\"" . $textdir['center'] . "\" valign=\"top\"><font size=\"-1\"><b>" . $text['size'] . "</b></font></th>\n"
		. "  </tr>\n"
		. "  <tr>\n"
		. "    <td class=\"row1\" align=\"" . $textdir['left'] . "\" valign=\"top\"><font size=\"-1\">" . $text['phymem'] . "</font></td>\n"
		. "    <td class=\"row2\" align=\"" . $textdir['left'] . "\" valign=\"top\"><font size=\"-1\">" . $strRam . "</font></td>\n"
		. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">" . format_bytesize( $XPath->getData( "/phpsysinfo/Memory/Free" ) ) . "</font></td>\n"
		. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">" . format_bytesize( $XPath->getData( "/phpsysinfo/Memory/Used" ) ) . "</font></td>\n"
		. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">" . format_bytesize( $XPath->getData( "/phpsysinfo/Memory/Total" ) ) . "</font></td>\n"
		. "  </tr>\n";
	if( isset( $strApp ) ) {
		$_text .= "  <tr>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['left'] . "\" valign=\"top\"><font size=\"-1\">- " . $text['app'] . "</font></td>\n"
			. "    <td class=\"row2\" align=\"" . $textdir['left'] . "\" valign=\"top\"><font size=\"-1\">" . $strApp . "</font></td>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">&nbsp;</font></td>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">" . format_bytesize( $XPath->getData( "/phpsysinfo/Memory/App" ) ) . "</font></td>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">&nbsp;</font></td>\n"
			. "  </tr>\n";
	}
	if( isset( $strBuffers ) ) {
		$_text .= "  <tr>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['left'] . "\" valign=\"top\"><font size=\"-1\">- " . $text['buffers'] . "</font></td>\n"
			. "    <td class=\"row2\" align=\"" . $textdir['left'] . "\" valign=\"top\"><font size=\"-1\">" . $strBuffers . "</font></td>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">&nbsp;</font></td>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">" . format_bytesize( $XPath->getData( "/phpsysinfo/Memory/Buffers" ) ) . "</font></td>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">&nbsp;</font></td>\n"
			. "  </tr>\n";
	}
	...
	if( isset( $strCached ) ) {
		$_text .= "  <tr>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['left'] . "\" valign=\"top\"><font size=\"-1\">- " . $text['cached'] . "</font></td>\n"
			. "    <td class=\"row2\" align=\"" . $textdir['left'] . "\" valign=\"top\"><font size=\"-1\">" . $strCached . "</font></td>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">&nbsp;</font></td>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">" . format_bytesize( $XPath->getData( "/phpsysinfo/Memory/Cached" ) ) . "</font></td>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">&nbsp;</font></td>\n"
			. "  </tr>\n";
	}
	...
	if( isset( $strSwap ) ) {
		$_text .= "  <tr>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['left'] . "\" valign=\"top\"><font size=\"-1\">" . $text['swap'] . "</font></td>\n"
			. "    <td class=\"row2\" align=\"" . $textdir['left'] . "\" valign=\"top\"><font size=\"-1\">" . $strSwap . "</font></td>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">" . format_bytesize( $XPath->getData( "/phpsysinfo/Swap/Free" ) ) . "</font></td>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">" . format_bytesize( $XPath->getData( "/phpsysinfo/Swap/Used" ) ) . "</font></td>\n"
			. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">" . format_bytesize( $XPath->getData( "/phpsysinfo/Swap/Total" ) ) . "</font></td>\n"
			. "  </tr>\n";
	}
	...
	if( ($max = sizeof( $XPath->getDataParts( "/phpsysinfo/Swapdevices" ) ) ) > 2 ) {
		for( $i = 1; $i < $max; $i++ ) {
			...
			$_text .= "  <tr>\n"
				. "    <td class=\"row1\" align=\"" . $textdir['left'] . "\" valign=\"top\"><font size=\"-1\"> - " . $XPath->getData( "/phpsysinfo/Swapdevices/Mount[" . $i . "]/Device/Name" ) . "</font></td>\n"
				. "    <td class=\"row1\" align=\"" . $textdir['left'] . "\" valign=\"top\"><font size=\"-1\">" . $strSwapdev . "</font></td>\n"
				. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">" . format_bytesize( $XPath->getData("/phpsysinfo/Swapdevices/Mount[" . $i . "]/Free" ) ) . "</font></td>\n"
				. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">" . format_bytesize( $XPath->getData("/phpsysinfo/Swapdevices/Mount[" . $i . "]/Used" ) ) . "</font></td>\n"
				. "    <td class=\"row1\" align=\"" . $textdir['right'] . "\" valign=\"top\"><font size=\"-1\">" . format_bytesize( $XPath->getData("/phpsysinfo/Swapdevices/Mount[" . $i . "]/Size" ) ) . "</font></td>\n"
				. "  </tr>\n";
		}
	}
	$_text .= "</table>";
